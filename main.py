...
def main(calib_file=CALIB_FILE, CKPT=CKPT, SMOOTH_ALPHA=SMOOTH_ALPHA, FIX_RADIUS=FIX_RADIUS, FIX_TIME=FIX_TIME, UNLOCK_EYE_TIME=UNLOCK_EYE_TIME, CONSEC_FRAMES=CONSEC_FRAMES, EAR_THRESHOLD=EAR_THRESHOLD, CALIB_STD_THRESHOLD=CALIB_STD_THRESHOLD, device=None):
    if device is None:
